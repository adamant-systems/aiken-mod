...
pub struct Context {
    ...
    pub blst_p1_list: Vec<()>,
    pub blst_p2_list: Vec<()>,
    ...
    pub fn run_once_pass(self) -> Self {
        ...
        for (index, blst_p1) in context.blst_p1_list.into_iter().enumerate() {
            ...
            term = term
                ...
                .apply(Term::bls12_381_g1_uncompress().apply(Term::byte_string(vec![])));
        }
        ...
        for (index, blst_p2) in context.blst_p2_list.into_iter().enumerate() {
            ...
            term = term
                ...
                .apply(Term::bls12_381_g2_uncompress().apply(Term::byte_string(vec![])));
        }
